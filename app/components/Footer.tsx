...
export default function Footer() {
  return (
    <footer className="text-center py-6 border-t shadow-md bg-newblack text-white">
      {/* Logo Section */}
      <div className="flex justify-center mb-8">
        <Link href="/">
          <img
            src="/With Tomato-Gold.png" // Replace with your actual logo path
            alt="Logo"
            className="h-24 md:h-32" // Adjust size as needed
          />
        </Link>
      </div>
